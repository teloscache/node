...
#general
export SRC_CHAINNAME=telos

#CORE CONTRACT
export SRC_CORE_SYMBOL=" TLOS" 
...
export SRC_CACHE_CURRENCY_STATS_SCOPE=76176668312404
...
export SRC_NETWORK_COLOR=$PURPLE  #👋 update me (optional)
